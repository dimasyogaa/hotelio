...
class DetailBooking extends StatelessWidget {
  ...
  Container roomDetails(BuildContext context, Booking booking) {
    return Container(
      decoration: BoxDecoration(
          color: Colors.white, borderRadius: BorderRadius.circular(16)),
      padding: const EdgeInsets.all(16),
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          itemRoomDetail(context, 'Check-in Time', booking.breakfast),
          const SizedBox(height: 8),
          itemRoomDetail(
              context, '${booking.night} night', AppFormat.currency(booking.totalPayment.toDouble() / 1 - 6 - 40)),
          const SizedBox(height: 8),
          itemRoomDetail(context, 'Service fee', AppFormat.currency(booking.serviceFee.toDouble())),
          const SizedBox(height: 8),
          itemRoomDetail(context, 'Activities', AppFormat.currency(booking.activities.toDouble())),
          const SizedBox(height: 8),
